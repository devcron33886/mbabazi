        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <a href="{{ route('welcome') }}" class="-m-1.5 p-1.5">
                    ...
                    <img class="h-12 w-auto rounded-full" src="{{ asset('assets/images/Jacques MBABAZI.webp') }}"
                        alt="Jacques MBABAZI">
                </a>
            </div>
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="#" wire:navigate
                    class="text-sm font-semibold leading-6 text-white hover:text-slate-400 transition duration-150 ease-in-out">Shop</a>

                <a href="#" wire:navigate
                    class="text-sm font-semibold leading-6 text-white hover:text-slate-400 transition duration-150 ease-in-out">Contact
                    Me</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="/admin/login" wire:navigate
                    class="text-sm font-semibold leading-6 text-white hover:text-slate-400 transition duration-150 ease-in-out">Log
