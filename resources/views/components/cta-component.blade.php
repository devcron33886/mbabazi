<div class="relative isolate overflow-hidden bg-gray-900">
    <div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Need to get visible online?.<br>Start
                Working with me.</h2>
            <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">I am avaialable for web development works.
            </p>
